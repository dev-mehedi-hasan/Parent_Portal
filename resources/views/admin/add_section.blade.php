                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <form action="{{URL::to('/create_section')}}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <h3 style="margin-right: 50px;" class="register-heading">Create Section</h3>
                                <div class="row register-form">
                                    <div class="col-md-6">
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select name="Sec_teacher" class="form-control" required="">
                                                <option class="hidden"  selected disabled>Teacher</option>
                                                 @foreach($teachers as $key =>$teacher)
                                                <option value="{{$teacher->Teacher_id}}">{{$teacher->teacher_name}} ({{$teacher->department_name}})</option>
                                                 @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
