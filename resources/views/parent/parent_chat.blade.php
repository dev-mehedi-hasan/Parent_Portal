         ...
         foreach ($parent_chatlist as $key => $value) {?>
            <li class="active grey lighten-3 p-2">
              <a href="{{URL::to('parent_chat_with/').'/'.$value->Teacher_id}}" class="d-flex justify-content-between">
                <img src="images/teacher/picture/Mr. Md. Anwar Hossen.jpg" alt="avatar" class="avatar rounded-circle d-flex align-self-center mr-2 z-depth-1">
      ...
      <div class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
       ...
       {{ csrf_field() }}
          <div class="white">
            ...
            <input type="hidden" id="custId" name="teacher_id" value="<?php echo $Sender_id;?>">
