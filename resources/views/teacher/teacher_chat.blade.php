    ...
    <!-- Grid column -->
      <div class="col-md-6 col-xl-4 px-0">
        ...
        <div class="white z-depth-1 px-2 pt-3 pb-0 members-panel-1 scrollbar-light-blue">
         ...
         foreach ($teacher_chatlist as $key => $value) {?>
            <li class="active grey lighten-3 p-2">
              <a href="{{URL::to('teacher_chat_with/').'/'.$value->Parent_id}}" class="d-flex justify-content-between">
                <img src="/images/parent/picture/meherunnahar.jpg" alt="avatar" class="avatar rounded-circle d-flex align-self-center mr-2 z-depth-1">
                <div class="text-small">
                  <strong><?php echo($value->parent_name);?></strong>
                  <p class="last-message text-muted"><?php echo($value->student_academic_id);?></p>
                </div>
        ...
        <div class="chat-message">
          ...
          <ul class="list-unstyled chat-1 scrollbar-light-blue">
           ...
           <div style="text-align: left; margin-top: 10px; margin-bottom: 5px;">
              <img src="/images/teacher/picture/Mr. Md. Anwar Hossen.jpg" alt="avatar" class="avatar rounded-circle mr-2 ml-lg-3 ml-0 z-depth-1">
           ...
           <?php 
            ...
            else if($value->Sender_id == $Sender_id)
            { 
            ?>
            <div style="text-align: right; margin-top: 10px; margin-bottom: 5px;">
            <?php echo($Parent_name); ?>
            <img src="/images/parent/picture/meherunnahar.jpg" alt="avatar" class="avatar rounded-circle mr-2 ml-lg-3 ml-0 z-depth-1">
            </div>
          ...
          ?> 
           ...
           <form action="{{URL::to('teacher_message_sending_to/')}}" method="post" enctype="multipart/form-data">
       {{ csrf_field() }}
          <div class="white">
            <div class="form-group basic-textarea">
            <input type="hidden" id="custId" name="parent_id" value="<?php echo $Sender_id;?>">
