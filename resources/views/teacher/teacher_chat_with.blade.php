  ...
  <div class="card-body">
   ...
   <!-- Grid column -->
      <div class="col-md-6 col-xl-4 px-0">
        ...
        <h6 class="font-weight-bold mb-3 text-center text-lg-left">Parents</h6>
      ...
      <div class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
        ...
        <div class="chat-message">
          ...
          <ul class="list-unstyled chat-1 scrollbar-light-blue">
           ...
           <?php 
            ...
            else if($value->Sender_id == $Parent_id)
            { 
            ?>
       ...
       {{ csrf_field() }}
          <div class="white">
            ...
            <input type="hidden" id="custId" name="parent_id" value="<?php echo $Parent_id;?>">
